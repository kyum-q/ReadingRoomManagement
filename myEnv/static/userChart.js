// Chart 객체에 넘겨줄 차트에 대한 정보들을 정의한 객체. 명품 html5의 7장 프>로토타입 참고
var config = {
    // type은 차트 종류 지정
...
function addEnvironmentChartData(value, i) {
    ...
    tick %= 100; // tick의 범위는 0에서 99까지만. 100보다 크면 다시 0부터
    시작
